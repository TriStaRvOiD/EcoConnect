...
val md_theme_light_surfaceVariant = Color(0xFFE8E7F0)
...
val md_theme_dark_surface = Color(0xFF121212) // A darker surface color for better contrast
val md_theme_dark_surfaceVariant = Color(0xFF1A1A1A) // Surface variant for the bottom nav bar
